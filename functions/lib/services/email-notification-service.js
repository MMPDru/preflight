...
class EmailNotificationService {
     ...
     */
    async sendProofReadyNotification(data) {
...
PreFlight Pro Team
     ...
     */
    async scheduleReminders(jobId, deadline) {
        const now = new Date();
