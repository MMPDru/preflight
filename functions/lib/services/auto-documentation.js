...
exports.getDocumentationService = getDocumentationService;
...
class AutoDocumentationService {
     ...
     */
    async detectChanges(commitHash) {
     ...
     */
    determineChangeType(files, message, diff) {
     ...
     */
    async generateDocumentation(change) {
     ...
     */
    buildDocumentationPrompt(change) {
...
- Highlight benefits to users`;
     ...
     */
    validateAndEnhanceDocumentation(doc, change) {
     ...
     */
    async generateVideoScript(documentation) {
...
Return JSON:
{
  ...
  "scenes": [
     ...
     */
    async updateTrainingModules(documentation, affectedModules) {
     ...
     */
    async generateModuleUpdate(moduleId, documentation) {
        return {
            moduleId,
...
// Export singleton
let docService = null;
function getDocumentationService(apiKey, repoPath) {
    if (!docService) {
...
//# sourceMappingURL=auto-documentation.js.map