...
export interface Permission {
    id: string;
    name: string;
    resource: string; // 'jobs', 'users', 'settings', 'approvals', etc.
...
export interface PricingCondition {
    field: string; // 'pageCount', 'customerId', 'priority', etc.
...
export interface QuoteItem {
    ...
    unitPrice: number;
    total: number;
    appliedRules: string[]; // Pricing rule IDs
}
...
export interface FeatureToggle {
    ...
    description: string;
    enabled: boolean;
    enabledFor?: string[]; // User IDs or customer IDs
    updatedAt: Date;
}
