...
export class AuditService {
     ...
     */
    private generateGDPRReport(logs: AuditLog[]): Record<string, any> {
     ...
     */
    private generateDataAccessReport(logs: AuditLog[]): Record<string, any> {
     ...
     */
    private generateRetentionReport(logs: AuditLog[]): Record<string, any> {
        return {
     ...
     */
    private generateDeletionReport(logs: AuditLog[]): Record<string, any> {
